<template>
    <div class="addEdit-block">
        ...
        >
            <el-row>
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'"  label="评测试卷编号" prop="examredetailsUuidNumber">
                        <el-input v-model="ruleForm.examredetailsUuidNumber"
                                  placeholder="评测试卷编号" clearable  :readonly="ro.examredetailsUuidNumber"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="评测试卷编号" prop="examredetailsUuidNumber">
                            <el-input v-model="ruleForm.examredetailsUuidNumber"
                                      placeholder="评测试卷编号" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
    ...
    export default {
        data() {
            ...
            return {
                ...
                rules: {
                    examredetailsUuidNumber: [
                        { required: true, message: '评测试卷编号不能为空', trigger: 'blur' },
                    ],
                    yonghuId: [
